...
@register.simple_tag
def get_delete_exchange_rate_url(exchange_rate_level, exchange_rate, organization, workspace=None):
    if exchange_rate_level == "organization":
        return reverse(
...
@register.simple_tag
def get_detail_exchange_rate_url(exchange_rate_level, exchange_rate, organization, workspace=None):
    if exchange_rate_level == "organization":
        return reverse(
