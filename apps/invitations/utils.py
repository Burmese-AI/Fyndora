...
def get_invitation_url(request=None, invitation: Invitation=None, domain_override: str=None) -> str:
    ...
    relative_path = reverse("accept_invitation", kwargs={'invitation_token': invitation.token})
