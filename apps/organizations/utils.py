...
def extract_organization_context(organization):
    ...
    return {
        ...
        "owner_id": str(organization.owner.user.user_id) if organization.owner and organization.owner.user else None,
        "owner_email": organization.owner.user.email if organization.owner and organization.owner.user else None,
    }
...
def extract_organization_exchange_rate_context(exchange_rate):
    ...
    return {
        ...
        "added_by_id": str(exchange_rate.added_by.user.user_id) if exchange_rate.added_by and exchange_rate.added_by.user else None,
        "added_by_email": exchange_rate.added_by.user.email if exchange_rate.added_by and exchange_rate.added_by.user else None,
