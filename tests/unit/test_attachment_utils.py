...
from apps.attachments.utils import validate_uploaded_files, extract_attachment_business_context
...
class TestValidateUploadedFiles(TestCase):
    ...
    def test_validate_uploaded_files_with_unsupported_extension(self):
        ...
        assert ".py" in error_message or ".txt" in error_message or ".zip" in error_message
...
class TestExtractAttachmentBusinessContext(TestCase):
    ...
    def test_extract_attachment_business_context_relationship_integrity(self):
        ...
        assert context["workspace_id"] == str(self.attachment.entry.workspace.workspace_id)
        assert context["organization_id"] == str(self.attachment.entry.workspace.organization.organization_id)
