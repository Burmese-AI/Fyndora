...
class TestGetClosestExchangedRate:
    ...
    def test_get_workspace_exchange_rate_closest_date(self):
        ...
        old_rate = WorkspaceExchangeRateFactory(
            workspace=self.workspace,
            currency=self.currency,
            rate=Decimal("0.9"),
        ...
        future_rate = WorkspaceExchangeRateFactory(
            workspace=self.workspace,
            currency=self.currency,
            rate=Decimal("1.1"),
            effective_date=self.occurred_at + timedelta(days=1),
    ...
    def test_get_organization_rate_closest_date(self):
        ...
        # Create rates with different dates
        old_rate = OrganizationExchangeRateFactory(
            organization=self.organization,
            currency=self.currency,
            rate=Decimal("0.9"),
            effective_date=self.occurred_at - timedelta(days=10)
        ...
        future_rate = OrganizationExchangeRateFactory(
            organization=self.organization,
            currency=self.currency,
            rate=Decimal("1.1"),
            effective_date=self.occurred_at + timedelta(days=1)
    ...
    def test_workspace_rate_future_date_fallback_to_org(self):
        ...
        future_workspace_rate = WorkspaceExchangeRateFactory(
            workspace=self.workspace,
            currency=self.currency,
            rate=Decimal("1.1"),
            effective_date=self.occurred_at + timedelta(days=1),
    ...
    def test_workspace_rate_unapproved_fallback_to_org(self):
        ...
        unapproved_workspace_rate = WorkspaceExchangeRateFactory(
            workspace=self.workspace,
            currency=self.currency,
            rate=Decimal("1.1"),
            effective_date=self.occurred_at,
    ...
    def test_different_currency_codes(self):
        ...
        eur_currency = Currency.objects.get_or_create(code="EUR", defaults={"name": "Euro"})[0]
        usd_currency = Currency.objects.get_or_create(code="USD", defaults={"name": "US Dollar"})[0]
