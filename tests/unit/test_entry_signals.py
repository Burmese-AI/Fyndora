...
class TestKeepRemittanceUpdatedWithEntry:
    ...
    def test_income_entry_triggers_due_amount_calculation(
        self, mock_update_remittance, mock_calculate_due
    ):
    ...
    def test_remittance_entry_triggers_paid_amount_calculation(
        self, mock_update_remittance, mock_calculate_paid
    ):
    ...
    @patch("apps.entries.signals.calculate_due_amount")
    @patch("apps.entries.signals.update_remittance")
    def test_entry_update_triggers_remittance_calculation(
        self, mock_update_remittance, mock_calculate_due
    ):
    ...
    @patch("apps.entries.signals.calculate_paid_amount")
    @patch("apps.entries.signals.update_remittance")
    def test_multiple_entry_types_in_same_workspace_team(
        self, mock_update_remittance, mock_calculate_paid, mock_calculate_due
    ):
...
class TestRevertRemittanceOnEntryDelete:
    ...
    @patch("apps.entries.signals.calculate_paid_amount")
    @patch("apps.entries.signals.update_remittance")
    def test_multiple_approved_entries_deletion(
        self, mock_update_remittance, mock_calculate_paid, mock_calculate_due
    ):
...
class TestEntrySignalIntegration:
    ...
    @patch("apps.entries.signals.calculate_due_amount")
    @patch("apps.entries.signals.update_remittance")
    def test_signal_handlers_are_connected(
        self, mock_update_remittance, mock_calculate_due
    ):
    ...
    @patch("apps.entries.signals.calculate_due_amount")
    @patch("apps.entries.signals.update_remittance")
    def test_signal_handlers_with_entry_updates(
        self, mock_update_remittance, mock_calculate_due
    ):
    ...
    def test_signal_handlers_with_entry_deletion(self):
        ...
        with patch("apps.entries.signals.calculate_due_amount") as mock_calculate_due:
            ...
            mock_calculate_due.assert_called_once_with(
                workspace_team=self.workspace_team
            )

    @patch("apps.entries.signals.calculate_due_amount")
    @patch("apps.entries.signals.update_remittance")
    def test_signal_handlers_with_different_entry_types(
        self, mock_update_remittance, mock_calculate_due
    ):
