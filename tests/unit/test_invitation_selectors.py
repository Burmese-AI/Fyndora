...
class TestInvitationSelectors(TestCase):
    ...
    def test_get_organization_member_by_user_and_organization(self):
        ...
        retrieved_member = selectors.get_organization_member_by_user_and_organization(
            user=created_member.user,
            organization=created_member.organization
        )
        
        # Verify the correct member is returned
        self.assertEqual(retrieved_member.organization_member_id, created_member.organization_member_id)
    ...
    def test_get_invitations_for_organization(self):
        ...
        invitations = selectors.get_invitations_for_organization(self.organization.organization_id)
    ...
    def test_get_invitation_by_token_exists(self):
        ...
        success, message, result_invitation = selectors.get_invitation_by_token(invitation.token)
    ...
    def test_get_invitation_by_token_not_exists(self):
        ...
        success, message, result_invitation = selectors.get_invitation_by_token(non_existent_uuid)
    ...
    def test_is_user_invitation_recipient_correct_email(self):
        ...
        is_recipient, message = selectors.is_user_invitation_recipient(self.user, invitation)
    ...
    def test_is_user_in_organization_false(self):
        ...
        is_in_org, message = selectors.is_user_in_organization(self.non_member_user, invitation)
