...
class TestInvitationUtils(TestCase):
    ...
    def test_get_invitation_url_with_request(self):
        ...
        expected_path = reverse("accept_invitation", kwargs={"invitation_token": self.invitation.token})
    ...
    def test_get_invitation_url_without_request_and_domain(self):
        ...
        self.assertEqual(str(context.exception), "Either request or domain_override is required")
