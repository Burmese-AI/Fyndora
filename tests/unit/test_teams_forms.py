...
class TeamFormTest(TestCase):
    ...
    def test_team_form_widgets(self):
        ...
        self.assertEqual(form.fields["title"].widget.attrs["placeholder"], "Enter team title")
        ...
        self.assertEqual(form.fields["description"].widget.attrs["placeholder"], "Describe your team (optional)")
    ...
    def test_team_form_team_coordinator_enabled(self):
        ...
        form = TeamForm(
            organization=self.organization,
            can_change_team_coordinator=True
        )
    ...
    def test_team_form_clean_title_duplicate_in_different_org(self):
        ...
        other_org_member = OrganizationMemberFactory(organization=other_organization)
...
class EditTeamMemberRoleFormTest(TestCase):
    ...
    def test_edit_team_member_role_form_clean_role_success(self):
        ...
        form = EditTeamMemberRoleForm(
            data={"role": TeamMemberRole.AUDITOR},
