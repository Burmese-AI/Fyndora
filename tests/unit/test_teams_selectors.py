...
class TeamSelectorsTest(TestCase):
    ...
    def setUp(self):
        ...
        self.team_member1 = TeamMemberFactory(
            organization_member=self.org_member1,
            team=self.team1
        )
        ...
        self.team_member3 = TeamMemberFactory(
            organization_member=self.org_member3,
            team=self.team3
        )
    ...
    def test_get_team_member_by_id_success(self):
        ...
        self.assertEqual(team_member.organization_member, self.team_member1.organization_member)
